...
cfg.IC=2;
cfg.threshold=.6
[tmpinv,tmpinv2,compselection]=gatherICmaps(cfg);
...
title(['rIFG: ', num2str(length(find(compselection(:,1)==1))),'/21'])

figure(2);
topoplot(mean(tmpinv2,2)', chanlocs)
title(['S1: ', num2str(length(find(compselection(:,1)==2))),'/21'])
...
load([cfg.par_fold,'compass_IC_AMICA1_info_OCCIPITAL.mat'])
...
compselection(compselection(:,4)<cfg.threshold,:)=[];
...
cfg.analysis.ERP_whole_window=dsearchn(timewindow',[-0.1 0.300]'); %P300
...
plot(timeX,mean(G1ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),1)))
hold on
plot(timeX,mean(G1ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),2)))
ylim([-5 10])
axis square
xline(0,'--')
yline(0,'--')
...
plot(timeX,mean(G2ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),1)))
hold on
plot(timeX,mean(G2ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),2)))
ylim([-5 10])
xline(0,'--')
yline(0,'--')
...
xline(0)
yline(0)
plot(timeX,mean(G3ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),1)))
hold on
plot(timeX,mean(G3ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),2)))
ylim([-5 10])
xline(0,'--')
yline(0,'--')
...
xline(0)
yline(0)
plot(timeX,mean(G1ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),3)))
hold on
plot(timeX,mean(G1ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),4)))
ylim([-5 10])
xline(0,'--')
yline(0,'--')
axis square
...
xline(0)
yline(0)
plot(timeX,mean(G2ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),3)))
hold on
plot(timeX,mean(G2ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),4)))
ylim([-5 10])
xline(0,'--')
yline(0,'--')
axis square
...
xline(0)
yline(0)
plot(timeX,mean(G3ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),3)))
hold on
plot(timeX,mean(G3ERP(:,cfg.analysis.ERP_whole_window(1):cfg.analysis.ERP_whole_window(2),4)))
ylim([-5 10])
xline(0,'--')
yline(0,'--')
axis square
